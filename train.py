...
def main():
	...
	parser.add_argument('--tacotron_train_steps', type=int, default=18000, help='total number of tacotron training steps') # Modif ! Default is 100000
	parser.add_argument('--wavenet_train_steps', type=int, default=15000, help='total number of wavenet training steps') # Modif ! Default is 500000
